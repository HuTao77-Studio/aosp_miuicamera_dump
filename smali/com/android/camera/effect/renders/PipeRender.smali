...
.method public drawOnExtraFrameBufferOnce(Lcom/android/camera/effect/draw_mode/DrawAttribute;)Z
    ...
    const-string/jumbo v7, "unsupported target "
    ...
    .line 7
    iget-object v5, v4, Lcom/android/camera/effect/draw_mode/DrawIntTexAttribute;->mDrawRect:Landroid/graphics/Rect;
    ...
    .line 9
    iget-object v6, v4, Lcom/android/camera/effect/draw_mode/DrawIntTexAttribute;->mDrawRect:Landroid/graphics/Rect;
    ...
    .line 10
    iget v4, v4, Lcom/android/camera/effect/draw_mode/DrawIntTexAttribute;->mTexId:I
    ...
    .line 12
    iget-object v5, v4, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mDrawRect:Landroid/graphics/Rect;
    ...
    .line 14
    iget-object v6, v4, Lcom/android/camera/effect/draw_mode/DrawRectShapeAttributeBase;->mDrawRect:Landroid/graphics/Rect;
    ...
    .line 15
    iget-object v4, v4, Lcom/android/camera/effect/draw_mode/DrawBasicTexAttribute;->mBasicTexture:Lcom/android/gallery3d/ui/BasicTexture;
    ...
    .line 17
    :cond_4
    iget v5, v0, Lcom/android/camera/effect/renders/PipeRender;->mBufferWidth:I

    .line 18
    iget v6, v0, Lcom/android/camera/effect/renders/PipeRender;->mBufferHeight:I
    ...
    check-cast v12, Lcom/android/camera/effect/renders/Render;
    ...
    .line 22
    :goto_2
    sget-object v14, Lcom/android/camera/effect/renders/PipeRender;->TAG:Ljava/lang/String;

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "renders["
    ...
    invoke-static {v14, v3}, Lcom/android/camera/effect/framework/gles/OpenGlUtils;->checkGlErrorAndWarning(Ljava/lang/String;Ljava/lang/String;)V

    if-eqz v13, :cond_6

    .line 23
    iget-object v3, v0, Lcom/android/camera/effect/renders/PipeRender;->mDoubleBuffer:Lcom/android/camera/effect/DoubleBuffer;

    invoke-virtual {v3}, Lcom/android/camera/effect/DoubleBuffer;->getOutputBuffer()Lcom/android/camera/effect/FrameBuffer;

    move-result-object v3

    invoke-virtual {v0, v3}, Lcom/android/camera/effect/renders/RenderGroup;->beginBindFrameBuffer(Lcom/android/camera/effect/FrameBuffer;)V

    .line 24
    sget-object v3, Lcom/android/camera/effect/renders/PipeRender;->TAG:Ljava/lang/String;

    const-string v14, "begin bind output buffer"

    invoke-static {v3, v14}, Lcom/android/camera/effect/framework/gles/OpenGlUtils;->checkFrameBufferStatusAndWarning(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 26
    invoke-static {v5, v6}, Lcom/android/camera/dualvideo/render/RectUtil;->create(II)Landroid/graphics/Rect;

    move-result-object v3

    invoke-direct {v8, v4, v3, v9}, Lcom/android/camera/effect/draw_mode/DrawIntTexAttribute;-><init>(ILandroid/graphics/Rect;Z)V

    .line 27
    invoke-virtual {v12, v8}, Lcom/android/camera/effect/renders/Render;->draw(Lcom/android/camera/effect/draw_mode/DrawAttribute;)Z

    goto :goto_3

    .line 28
    :cond_7
    invoke-virtual {v12, v1}, Lcom/android/camera/effect/renders/Render;->draw(Lcom/android/camera/effect/draw_mode/DrawAttribute;)Z
    ...
    invoke-virtual {v3}, Lcom/android/camera/effect/DoubleBuffer;->getInputBuffer()Lcom/android/camera/effect/FrameBuffer;
    ...
    invoke-virtual {v12, v3, v5, v6}, Lcom/android/camera/effect/renders/Render;->setPreviousFrameBufferInfo(III)V
    ...
    .line 30
    iget-object v3, v8, Lcom/android/camera/effect/draw_mode/DrawIntTexAttribute;->mDrawRect:Landroid/graphics/Rect;
    ...
    invoke-direct {v3, v8, v12, v9}, Lcom/android/camera/effect/draw_mode/DrawIntTexAttribute;-><init>(ILandroid/graphics/Rect;Z)V
