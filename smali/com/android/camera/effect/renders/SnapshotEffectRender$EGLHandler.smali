...
.method private applyEffect(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;IZLcom/android/camera/effect/renders/SnapshotEffectRender$Size;Lcom/android/camera/effect/renders/SnapshotEffectRender$Size;)[B
    ...
    iget v7, v1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectCvIndex:I
    ...
    .line 18
    :goto_3
    invoke-direct {v0, v1, v9}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->getEffectRender(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Z)Lcom/android/camera/effect/renders/Render;
...
.method private applyEffectOnlyWatermarkRange(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Lcom/android/camera/effect/renders/SnapshotEffectRender$Size;Lcom/android/camera/effect/renders/SnapshotEffectRender$Size;)[B
    ...
    .line 35
    invoke-direct {v0, v1, v3}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->getEffectRender(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Z)Lcom/android/camera/effect/renders/Render;
    ...
    .line 38
    :cond_5
    invoke-virtual {v9, v6, v7}, Lcom/android/camera/effect/renders/Render;->setPreviewSize(II)V

    .line 39
    iget-object v3, v1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mAttribute:Lcom/android/camera/effect/EffectController$EffectRectAttribute;

    invoke-virtual {v9, v3}, Lcom/android/camera/effect/renders/Render;->setEffectRangeAttribute(Lcom/android/camera/effect/EffectController$EffectRectAttribute;)V

    .line 40
    iget-boolean v3, v1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mMirror:Z

    invoke-virtual {v9, v3}, Lcom/android/camera/effect/renders/Render;->setMirror(Z)V
    ...
    invoke-virtual {v9, v6, v3}, Lcom/android/camera/effect/renders/Render;->setSnapshotSize(II)V

    .line 42
    iget v3, v1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mOrientation:I

    invoke-virtual {v9, v3}, Lcom/android/camera/effect/renders/Render;->setOrientation(I)V

    .line 43
    iget v3, v1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mShootRotation:F

    invoke-virtual {v9, v3}, Lcom/android/camera/effect/renders/Render;->setShootRotation(F)V

    .line 44
    iget v3, v1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mJpegOrientation:I

    invoke-virtual {v9, v3}, Lcom/android/camera/effect/renders/Render;->setJpegOrientation(I)V
    ...
    invoke-virtual {v3}, Lcom/android/camera/effect/framework/graphics/GraphicBuffer;->getFrameBufferId()I
    ...
    invoke-static {v6}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$100(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Lcom/android/camera/effect/SnapshotCanvas;

    move-result-object v6

    invoke-virtual {v6, v3, v10, v14}, Lcom/android/gallery3d/ui/BaseGLCanvas;->beginBindFrameBuffer(III)V
    ...
    .line 49
    invoke-virtual {v9}, Lcom/android/camera/effect/renders/Render;->deleteBuffer()V
    ...
    invoke-direct {v0, v2, v5, v3, v11}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->drawWaterMark(Lcom/android/camera/effect/renders/WaterMark;III)V
...
.method private applyMiMovieBlackBridge(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Lcom/android/camera/effect/renders/SnapshotEffectRender$Size;)[B
    ...
    .line 10
    invoke-direct {p0, p1, v4}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->getEffectRender(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Z)Lcom/android/camera/effect/renders/Render;
...
.method private blockSplitApplyEffect(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;IZLcom/android/camera/effect/renders/SnapshotEffectRender$Size;Lcom/android/camera/effect/renders/SnapshotEffectRender$Size;)V
    ...
    .line 16
    invoke-direct {v9, v10, v14}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->getEffectRender(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Z)Lcom/android/camera/effect/renders/Render;
    ...
    .line 18
    :cond_3
    invoke-virtual {v15, v2, v3}, Lcom/android/camera/effect/renders/Render;->setPreviewSize(II)V
    ...
    .line 21
    invoke-virtual {v15, v11, v12}, Lcom/android/camera/effect/renders/Render;->setSnapshotSize(II)V
    ...
    invoke-virtual {v15, v0, v1}, Lcom/android/camera/effect/renders/Render;->setSnapshotSize(II)V

    .line 23
    :goto_2
    iget v0, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mOrientation:I

    invoke-virtual {v15, v0}, Lcom/android/camera/effect/renders/Render;->setOrientation(I)V

    .line 24
    iget v0, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mShootRotation:F

    invoke-virtual {v15, v0}, Lcom/android/camera/effect/renders/Render;->setShootRotation(F)V

    .line 25
    iget v0, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mJpegOrientation:I

    invoke-virtual {v15, v0}, Lcom/android/camera/effect/renders/Render;->setJpegOrientation(I)V
    ...
    .line 28
    invoke-virtual {v15, v0}, Lcom/android/camera/effect/renders/Render;->setParentFrameBufferId(I)V
    ...
    .line 38
    :goto_4
    iput v3, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mWidth:I

    .line 39
    iput v2, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mHeight:I
    ...
    iget-object v8, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mDeviceWatermarkParam:Lcom/android/camera/effect/renders/DeviceWatermarkParam;

    invoke-static {v1, v10, v8}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$1800(Lcom/android/camera/effect/renders/WaterMark;Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Lcom/android/camera/effect/renders/DeviceWatermarkParam;)Lcom/android/camera/effect/renders/WaterMark;
    ...
    invoke-static {v1, v10, v8}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2000(Lcom/android/camera/effect/renders/WaterMark;Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Lcom/android/camera/effect/renders/DeviceWatermarkParam;)Lcom/android/camera/effect/renders/WaterMark;
    ...
    iget v8, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mJpegOrientation:I
    ...
    iget-object v14, v9, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->this$0:Lcom/android/camera/effect/renders/SnapshotEffectRender;

    invoke-static {v14}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$1900(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Lcom/android/camera/effect/renders/WaterMark;

    move-result-object v14

    invoke-static {v0, v1, v8, v7, v14}, Lcom/android/camera/watermark/WaterMarkUtil;->getWatermarkRange(IIILcom/android/camera/effect/renders/WaterMark;Lcom/android/camera/effect/renders/WaterMark;)[I
    ...
    invoke-direct {v0, v7, v14, v6, v8}, Landroid/graphics/RectF;-><init>(FFFF)V
    ...
    invoke-static {v7, v8, v14, v0, v6}, Lcom/android/camera/effect/ShaderNativeUtil;->genWaterMarkRange(IIIII)V
    ...
    .line 55
    iget v8, v0, Lcom/android/camera/effect/framework/graphics/Block;->mHeight:I

    move-object/from16 v24, v14

    .line 56
    iget v14, v0, Lcom/android/camera/effect/framework/graphics/Block;->mRowStride:I

    move/from16 v25, v4

    .line 57
    iget v4, v0, Lcom/android/camera/effect/framework/graphics/Block;->mOffset:I
    ...
    iget v5, v5, Lcom/android/camera/effect/framework/image/MemImage;->mChannels:I

    move-object/from16 v27, v7

    .line 59
    instance-of v7, v15, Lcom/android/camera/effect/renders/PipeRender;
    ...
    invoke-virtual {v7, v3, v2}, Lcom/android/camera/effect/renders/PipeRender;->setFrameBufferSize(II)V

    .line 61
    :cond_8
    iget-boolean v7, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mIsNeedDrak:Z

    invoke-virtual {v15, v7}, Lcom/android/camera/effect/renders/Render;->setDarkEffectEnable(Z)V

    const/4 v7, 0x0

    .line 62
    invoke-static {v7, v7, v1, v8}, Landroid/opengl/GLES20;->glViewport(IIII)V
    ...
    .line 63
    invoke-static {v2, v7, v7, v2}, Landroid/opengl/GLES20;->glClearColor(FFFF)V
    ...
    const-string v2, "[loop%d/%d]gl predraw"
    ...
    invoke-virtual {v7, v2}, Lcom/android/camera/effect/framework/utils/CounterUtil;->tick(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2200(Lcom/android/camera/effect/renders/SnapshotEffectRender;)I
    ...
    const-string v4, "[loop%d/%d]gl uploadtexture textureId %d"
    ...
    invoke-static {v4}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2600(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Lcom/android/camera/effect/framework/utils/CounterUtil;
    ...
    invoke-static {v1, v8}, Lcom/android/camera/dualvideo/render/RectUtil;->create(II)Landroid/graphics/Rect;
    ...
    invoke-direct {v4, v5, v14, v3}, Lcom/android/camera/effect/draw_mode/DrawIntTexAttribute;-><init>(ILandroid/graphics/Rect;Z)V
    ...
    invoke-static/range {v37 .. v43}, Lcom/android/camera/effect/ShaderNativeUtil;->mergeWaterMarkRange(IIIIIII)V
    ...
    iget v1, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mJpegOrientation:I

    move/from16 v5, v17

    invoke-direct {v9, v0, v5, v15, v1}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->drawWaterMark(Lcom/android/camera/effect/renders/WaterMark;III)V

    .line 88
    iget-object v0, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mDeviceWatermarkParam:Lcom/android/camera/effect/renders/DeviceWatermarkParam;
    ...
    const-string v1, "[loop%d/%d]gl gldraw"
    ...
    invoke-virtual {v0, v1, v2, v4}, Lcom/android/camera/effect/framework/graphics/GraphicBuffer;->readBuffer(III)V
    ...
    const-string v1, "[loop%d/%d]gl readPixelAndMerge"
    ...
    .line 103
    invoke-static {v6, v0}, Lcom/android/camera/effect/ShaderNativeUtil;->getCenterSquareImage(II)V
    ...
    .line 106
    invoke-virtual/range {v31 .. v31}, Lcom/android/camera/effect/renders/Render;->deleteBuffer()V
    ...
    .line 110
    iput-object v0, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mDataOfTheRegionUnderWatermarks:[B

    move-object/from16 v1, v36

    .line 111
    iput-object v1, v10, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mCoordinatesOfTheRegionUnderWatermarks:[I
...
.method private drawMainJpeg(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;ZZ)Z
    ...
    iget v0, v7, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectCvIndex:I
    ...
    iget v1, v7, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectCvIndex:I

    move/from16 v22, v1

    iget-boolean v1, v7, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mIsNeedDrak:Z
    ...
    invoke-direct/range {v14 .. v45}, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;-><init>([BZIIIIIIZLcom/android/camera/effect/EffectController$EffectRectAttribute;Landroid/location/Location;Ljava/lang/String;JIIFZLjava/lang/String;ZLcom/xiaomi/camera/core/PictureInfo;ZZLjava/lang/String;ZZLcom/android/camera/effect/renders/DeviceWatermarkParam;ZIII)V
...
.method private drawThumbJpeg(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Z)Z
    ...
    invoke-static {v0, v7}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$3200(Lcom/android/camera/effect/renders/SnapshotEffectRender;Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;)Lcom/android/gallery3d/exif/ExifInterface;
    ...
    invoke-static {v1}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$3100(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Landroid/content/Context;
...
.method private getEffectRender(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;Z)Lcom/android/camera/effect/renders/Render;
    .locals 6
    ...
    .line 2
    iget p2, p1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectIndex:I
    ...
    invoke-static {p2}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2700(Lcom/android/camera/effect/renders/SnapshotEffectRender;)I
    ...
    iget v3, p1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectIndex:I
    ...
    invoke-direct {p0, p2}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->removeRender(I)V
    ...
    invoke-direct {p0, p2}, Lcom/android/camera/effect/renders/SnapshotEffectRender$EGLHandler;->fetchRender(I)Lcom/android/camera/effect/renders/Render;
    ...
    iget v1, p1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectIndex:I

    invoke-static {p2, v1}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2702(Lcom/android/camera/effect/renders/SnapshotEffectRender;I)I

    .line 10
    :cond_1
    iget p2, p1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectCvIndex:I
    ...
    invoke-static {p2}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2800(Lcom/android/camera/effect/renders/SnapshotEffectRender;)I
    ...
    iget v1, p1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectCvIndex:I
    ...
    invoke-static {p2, v1}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2802(Lcom/android/camera/effect/renders/SnapshotEffectRender;I)I
    ...
    .line 25
    iget p1, p1, Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;->mEffectIndex:I
...
.method private release()V
    ...
    invoke-static {p0}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$3300(Lcom/android/camera/effect/renders/SnapshotEffectRender;)V
...
.method private saveMainJpeg(Lcom/android/camera/effect/draw_mode/DrawJPEGAttribute;ZZ[B)Z
    ...
    invoke-static {v4}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2900(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Ljava/util/Map;
    ...
    invoke-static {v5}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$2900(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$3000(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Lcom/android/camera/storage/ImageSaver;
    ...
    invoke-static {v0}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$3000(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Lcom/android/camera/storage/ImageSaver;
    ...
    invoke-static {v0}, Lcom/android/camera/effect/renders/SnapshotEffectRender;->access$3100(Lcom/android/camera/effect/renders/SnapshotEffectRender;)Landroid/content/Context;
