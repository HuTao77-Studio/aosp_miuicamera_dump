...
.method private updateSecondRender()V
    ...
    const-string v7, "effectId: 0x%x->0x%x KaleidoscopeEnabled: %b->%b"
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Lcom/android/camera/effect/renders/VideoRecorderRender;->getSecondRender(IIZZ)Lcom/android/camera/effect/renders/Render;
