...
# static fields
.field public static final MAX_REPROCESS_CACHE_COUNT:I = 0x1e
...
.method private loop()V
    ...
    const-string v3, "[1] loop: start take CameraImageReceiver to handle data: "
    ...
    const-string v5, "[1] loop: start requestData: "
...
.method private startReprocessLoop()V
    ...
    new-instance v1, LOooO0O0/OooO0o/OooO00o/OooO/OooO0Oo;

    invoke-direct {v1, p0}, LOooO0O0/OooO0o/OooO00o/OooO/OooO0Oo;-><init>(Lcom/xiaomi/camera/mivi/ImageReceiverExecutor;)V
...
.method public synthetic OooO0OO()V
    ...
    const-string v4, "[2] startReprocessLoop: mResultImageDataQueue size > "
    ...
    const-string v4, "[2] startReprocessLoop: current data: "
    ...
    const-string v2, "[2] startReprocessLoop: with null parallelTaskData"
    ...
    .line 8
    :cond_2
    invoke-virtual {v3}, Lcom/xiaomi/camera/core/ParallelTaskData;->isAbandoned()Z
    ...
    const-string v4, "[2] startReprocessLoop: parallelTaskData is abandon, start release data: "
    ...
    invoke-static {v5, v1, v3}, Lcom/android/camera/log/Log;->k(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v7, v6}, Lcom/xiaomi/camera/imagecodec/ImagePool;->releaseImage(Landroid/media/Image;)V
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcom/xiaomi/camera/MIVICaptureManager;->releaseData(Ljava/lang/String;J)V

    goto/16 :goto_0

    .line 14
    :cond_4
    iget-object v4, p0, Lcom/xiaomi/camera/mivi/ImageReceiverExecutor;->mReprocessSemaphore:Ljava/util/concurrent/Semaphore;

    invoke-virtual {v4}, Ljava/util/concurrent/Semaphore;->acquire()V

    .line 15
    iget-object v4, p0, Lcom/xiaomi/camera/mivi/ImageReceiverExecutor;->mIProcessor:Lcom/xiaomi/camera/mivi/IProcessor;

    invoke-virtual {v4, v2}, Lcom/xiaomi/camera/mivi/IProcessor;->process(Lcom/xiaomi/camera/mivi/bean/ResultImageData;)V
    ...
    :cond_6
    const-string v3, "[2] reprocess with CvReProcessor"
    ...
    :cond_9
    const-string v3, "[2] reprocess with VtReProcessorProxy"
...
.method public release()V
    ...
    new-instance v1, LOooO0O0/OooO0o/OooO00o/OooO/OooO0O0;

    invoke-direct {v1, p0}, LOooO0O0/OooO0o/OooO00o/OooO/OooO0O0;-><init>(Lcom/xiaomi/camera/mivi/ImageReceiverExecutor;)V
