...
.field public mDecodedFramesNumber:I
...
.method public constructor <init>(Ljava/lang/String;Landroid/os/Handler;JI)V
    ...
    .line 6
    iput v1, p0, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->mDecodedFramesNumber:I
    ...
    invoke-direct {p1, p0, p5}, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync$CustomCallback;-><init>(Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync$1;)V

    .line 13
    :try_start_0
    iget-object v1, p0, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->mMediaExtractor:Landroid/media/MediaExtractor;

    iget-object v2, p0, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->mTargetFile:Ljava/lang/String;
    ...
    .line 18
    iget-object v4, p0, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->mMediaParamsHolder:Lcom/miui/extravideo/common/MediaParamsHolder;
    ...
    iput v5, v4, Lcom/miui/extravideo/common/MediaParamsHolder;->videoWidth:I
    ...
    iput v5, v4, Lcom/miui/extravideo/common/MediaParamsHolder;->videoHeight:I
    ...
    invoke-static {v2, v5, v0}, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->getInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)I

    move-result v5

    iput v5, v4, Lcom/miui/extravideo/common/MediaParamsHolder;->videoDegree:I
    ...
    iput-wide v4, p0, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->mDuration:J

    .line 22
    iget-object v4, p0, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->mMediaParamsHolder:Lcom/miui/extravideo/common/MediaParamsHolder;

    iput-object v3, v4, Lcom/miui/extravideo/common/MediaParamsHolder;->mimeType:Ljava/lang/String;

    .line 23
    iget-object v4, p0, Lcom/miui/extravideoxmalgo/xaiomiAlogMedia/XiaomiAlgoDecoderAsync;->mMediaExtractor:Landroid/media/MediaExtractor;
    ...
    invoke-virtual {v1, p3, p4, v0}, Landroid/media/MediaExtractor;->seekTo(JI)V
    ...
    invoke-virtual {p1, v2, p5, p5, v0}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    :try_end_0
